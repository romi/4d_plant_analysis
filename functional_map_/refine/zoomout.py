...
def mesh_zoomout_refine(eigenvectors1, eigenvectors2, A2, FM, nit, step=1, subsample=None, use_ANN=False, return_p2p=False, verbose=False):
    """
    ...
    result = zoomout_refine(eigenvectors1, eigenvectors2, FM, nit,
                            step=step, A2=A2, subsample=subsample,
